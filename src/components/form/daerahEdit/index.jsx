...
export const ComponentProvinsiDanKotaEdit = (props) => {
  ...
  const [ provinsi, setProvinsi] = useState(props.dataEdit.provinsi)
  const [ listProvinsi, SetListProvinsi ] = useState([])
  const [ listKabKota, SetListKabKota ] = useState([])
  const [selectedValue, setSelectedValue] = useState(props.dataEdit[`kabKota`]);
  ...
  console.log(provinsi)
  console.log(selectedValue)
  console.log(listKabKota)
  // props.dataEdit[`kabKota`].map((data, i) => ({ label:data, value: data }))
  // let datakotass = listKabKota.filter(obj => selectedValue.includes(obj.value))
  // console.log(datakotass)
  
  useEffect(() => {
    if(props.dataEdit.provinsi){
      dispatch(dataKota(props.dataEdit.provinsi))
        .then(data => {
          SetListKabKota(data)
        })
    }
