            ...
            <Row>
              <Col md={{ span: 10, offset:1}} lg={{ span: 10, offset:1}} >
                <div className="part-one">
                  <Row>
                    <Col md={12} lg={12}>
                      <h3 className="text-center" style={{color:'#1f59bb'}}>Selamat, password anda sudah terganti <br/>Silahkan cek email anda dan password anda telah berganti</h3>
...
export default withRouter(SuccessForgotPassword)